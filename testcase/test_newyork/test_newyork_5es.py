...
@ddt
class Test_Room_Newyork_ES(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/es/new-york/5-star-luxury-hotel-midtown-nyc"
        try:
    ...
    def test_room_booking_newyork_es(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Newyork, es
        """
