...
@ddt
class Test_Room_Newyork_ZHCN(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/zh-cn/new-york/5-star-luxury-hotel-midtown-nyc"
        try:
    ...
    def test_room_booking_newyork_zh_cn(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Newyork, zh-cn
        """
