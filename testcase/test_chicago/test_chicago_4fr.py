...
@ddt
class Test_Room_Chicago_FR(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/fr/chicago/5-star-luxury-hotel-downtown-chicago"
        try:
    ...
    def test_room_booking_chicago_fr(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Chicago, fr
        """
