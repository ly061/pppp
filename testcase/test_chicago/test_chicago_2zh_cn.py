...
@ddt
class Test_Room_Chicago_ZHCN(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/zh-cn/chicago/5-star-luxury-hotel-downtown-chicago"
        try:
    ...
    def test_room_booking_chicago_zh_cn(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Chicago, zh-cn
        """
