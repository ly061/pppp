...
@ddt
class Test_Room_Chicago_ES(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/es/chicago/5-star-luxury-hotel-downtown-chicago"
        try:
    ...
    def test_room_booking_chicago_es(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Chicago, es
        """
