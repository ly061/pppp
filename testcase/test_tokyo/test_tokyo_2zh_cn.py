...
@ddt
class Test_Room_Tokyo_ZHCN(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/zh-cn/tokyo/5-star-luxury-hotel-ginza"
        try:
    ...
    def test_room_booking_tokyo_zh_cn(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Tokyo, zh-cn
        """
