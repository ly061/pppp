...
@ddt
class Test_Room_Tokyo_EN(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/en/tokyo/5-star-luxury-hotel-ginza"
        try:
    ...
    def test_room_booking_tokyo_en(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Tokyo, en
        """
