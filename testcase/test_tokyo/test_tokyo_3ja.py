...
@ddt
class Test_Room_Tokyo_JA(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/ja/tokyo/5-star-luxury-hotel-ginza"
        try:
    ...
    def test_room_booking_tokyo_ja(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Tokyo, ja
        """
