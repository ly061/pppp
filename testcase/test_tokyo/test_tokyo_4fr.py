...
@ddt
class Test_Room_Tokyo_FR(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/fr/tokyo/5-star-luxury-hotel-ginza"
        try:
    ...
    def test_room_booking_tokyo_fr(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Tokyo, fr
        """
