...
@ddt
class Test_Room_Manila_EN(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/en/manila/5-star-luxury-hotel-makati"
        try:
    ...
    def test_room_booking_manila_en(self):
        """
