...
@ddt
class Test_Room_Manila_JA(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/ja/manila/5-star-luxury-hotel-makati"
        try:
    ...
    def test_room_booking_manila_ja(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Manila, ja
        """
