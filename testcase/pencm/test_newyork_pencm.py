...
class Test_Room_HK_EN(unittest.TestCase):
    ...
    @parameterized.expand(lan_list['live']['newyork'])
    def test_room_booking_newyork(self, language):
        """
        Testing Property, Room, Romm Detail, Offer modules for Newyork,
        """
        self.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/{language}/new-york/5-star-luxury-hotel-midtown-nyc"
        try:
