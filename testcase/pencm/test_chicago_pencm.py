...
class Test_Room_HK_EN(unittest.TestCase):
    ...
    @parameterized.expand(lan_list['live']['chicago'])
    def test_room_booking_chicago(self, language):
        """
        Testing Property, Room, Romm Detail, Offer modules for Chicago,
        """
        self.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/{language}/chicago/5-star-luxury-hotel-downtown-chicago"
        try:
