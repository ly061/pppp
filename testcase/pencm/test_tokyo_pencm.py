...
class Test_Room_HK_EN(unittest.TestCase):
    ...
    @parameterized.expand(lan_list['live']['tokyo'])
    def test_room_booking_tokyo(self, language):
        """
        Testing Property, Room, Romm Detail, Offer modules for Tokyo,
        """
        self.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/{language}/tokyo/5-star-luxury-hotel-ginza"
        try:
