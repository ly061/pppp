...
@ddt
class Test_Room_HK_JA(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/ja/hong-kong/5-star-luxury-hotel-kowloon"
        try:
    ...
    def test_room_booking_hk_ja(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Hongkong, ja
        """
