...
@ddt
class Test_Room_HK_kR(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/kr/hong-kong/5-star-luxury-hotel-kowloon"
        try:
    ...
    def test_room_booking_hk_kr(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Hongkong, kr
        """
