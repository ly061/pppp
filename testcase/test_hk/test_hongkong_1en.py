...
class Test_Room_HK_EN(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/en/hong-kong/5-star-luxury-hotel-kowloon"
        try:
    ...
    def test_room_booking_hk_en(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Hongkong, en
        """
        ...
        self.property_page.offer_spa_booking_widget()
