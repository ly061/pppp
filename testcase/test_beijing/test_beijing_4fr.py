...
@ddt
class Test_Room_BJ_FR(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/fr/beijing/5-star-luxury-hotel-wangfujing"
        try:
    ...
    def test_room_booking_bj_fr(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Beijing, fr
        """
