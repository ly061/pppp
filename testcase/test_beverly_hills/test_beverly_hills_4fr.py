...
@ddt
class Test_Room_Beverly_hills_FR(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/fr/beverly-hills/5-star-luxury-hotel-beverly-hills"
        try:
    ...
    def test_room_booking_beverly_hills_fr(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Beverly hills, fr
        """
