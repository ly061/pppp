...
@ddt
class Test_Room_Beverly_hills_ZHCN(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/zh-cn/beverly-hills/5-star-luxury-hotel-beverly-hills"
        try:
    ...
    def test_room_booking_beverly_hills_zh_cn(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Beverly hills, zh-cn
        """
