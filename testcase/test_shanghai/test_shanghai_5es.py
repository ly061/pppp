...
@ddt
class Test_Room_SH_ES(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/es/shanghai/5-star-luxury-hotel-bund"
        try:
    ...
    def test_room_booking_sh_es(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Shanghai, es
        """
