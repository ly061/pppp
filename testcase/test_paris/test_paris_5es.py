...
@ddt
class Test_Room_Paris_ES(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/es/paris/5-star-luxury-hotel-16th-arrondissement"
        try:
    ...
    def test_room_booking_paris_es(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Paris, es
        """
