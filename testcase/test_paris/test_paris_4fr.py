...
@ddt
class Test_Room_Paris_FR(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/fr/paris/5-star-luxury-hotel-16th-arrondissement"
        try:
    ...
    def test_room_booking_paris_fr(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Paris, fr
        """
