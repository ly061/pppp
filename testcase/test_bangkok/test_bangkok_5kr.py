...
@ddt
class Test_Room_Bangkok_KR(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        cls.driver = firefox_browser()
        cls.bace_url_test = f"https://{HomePage.environment_pen}.peninsula.com/kr/bangkok/5-star-luxury-hotel-riverside"
        try:
    ...
    def test_room_booking_bangkok_kr(self):
        """
        Testing Property, Room, Romm Detail, Offer modules for Bangkok, kr
        """
